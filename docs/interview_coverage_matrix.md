...
| CTR calibration drift | auctions, delayed labels, business impact | recalibration service and drift monitors | calibration config and KPI framework | 1 to 4 |
...
| Logistic Regression at internet scale | sparse features, hashing, low latency | Criteo-based sparse LR system with hashed features | architecture doc and model config | 1 to 5 |
...
| Hybrid ad ranking system | LR plus deep reranking and exploration | stage-1 linear scorer, stage-2 deep reranker, stage-3 calibration | architecture doc | 1 and 7 |
